...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        tasks_data = [
            ...
            {'task_number': 'CSG-2026-0026', 'title': 'Mid-Year Constitutional Review Assembly', 'desc': 'Conduct mid-year review of council resolutions and bylaws.', 'priority': 'urgent', 'status': 'processing', 'progress': 100, 'due_date': '2026-07-24', 'org': csg_org, 'created_by': 'admin', 'assignees': ['em_david', 'treas_ben']},
            ...
            {'task_number': 'CSG-2026-0020', 'title': 'OCA Event Approval for Cultural Night', 'desc': 'Prepare and submit event proposal paperwork to the Office of Cultural Affairs.', 'priority': 'urgent', 'status': 'oca', 'progress': 60, 'due_date': '2026-07-29', 'org': csg_org, 'created_by': 'admin', 'assignees': ['ext_mark']},
            ...
            {'task_number': 'CSG-2026-0016', 'title': 'Cook Ilocos Empanada', 'desc': 'hkdsjhfjkdshfaweafae fesfesfesfe', 'priority': 'low', 'status': 'not_started', 'progress': 0, 'due_date': '2026-07-31', 'org': csg_org, 'created_by': 'admin', 'assignees': ['vp_juan', 'treas_ben', 'auditor_lea', 'sec_anna', 'president']},
